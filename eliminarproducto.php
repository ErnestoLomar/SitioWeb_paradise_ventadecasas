...
<div id="f2">
<form name="resultados" method="post" action='eliminarproducto2.php'>
...
<input type="text" name="descripcion" maxlenght="100" size="50" value="<?php echo $correo ?>">
<input type="text" name="desc" maxlenght="100" size="50" value="<?php echo $descripcion ?>">

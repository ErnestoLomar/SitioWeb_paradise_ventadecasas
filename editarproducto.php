...
$clave = $_POST['clave'];
$result = mysqli_query($link, "SELECT * FROM productos WHERE id_producto=$clave");
...
<div id="f2">
<form name="resultados" method="post" action="editarproducto2.php" enctype="multipart/form-data">
...
<label for="" style="color: white; margin: 5px;">Descripcion:</label>
<input type="text" name="descripcion" maxlenght="100" size="50" value="<?php echo $descripcion?>">
<label for="" style="color: white; margin: 5px;">Categoria:</label>
<input type="text" name="categoria" maxlenght="100" size="50" value="<?php echo $categoria ?>">
